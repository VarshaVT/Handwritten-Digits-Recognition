...
with(rpart, scatter.smooth(rpart$prediction.rpart, rpart$`cv$Y`, main="Actual Vs Predicted (rpart)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
...
with(naiveBayes, scatter.smooth(naiveBayes$prediction.naiveBayes, naiveBayes$`cv$Y`, main="Actual Vs Predicted (NaiveBays)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
...
with(svm, scatter.smooth(svm$prediction.svm, svm$`cv$Y`, main="Actual Vs Predicted (SVM)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
...
with(fnn, scatter.smooth(fnn$prediction.digit, fnn$`cv$Y`, main="Actual Vs Predicted (FNN::knn)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
...
with(randomForest, scatter.smooth(randomForest$prediction.randomForest, randomForest$`cv$Y`, main="Actual Vs Predicted (RandomForest)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
...
with(knn, scatter.smooth(knn$prediction.knn, knn$`cv$Y`, main="Actual Vs Predicted (RWeka::IBk)",  xlab = "Predicted Digits", ylab = "Actual Digits", lpars = list(col = "red", lwd = 1, lty = 1)))
